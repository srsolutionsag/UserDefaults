...
```php
use srag\DIC\UserDefaults\x\DICStatic;use srag\Plugins\x\x\x;DICStatic::dic()->database()->createAutoIncrement(x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\UserDefaults\x\Version\PluginVersionParameter;
...
